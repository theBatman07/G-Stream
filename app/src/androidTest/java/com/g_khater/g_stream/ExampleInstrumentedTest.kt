...
class ExampleInstrumentedTest {
    private fun getAllProviders(): Array<com.g_khater.g_stream.MainAPI> {
        println("Providers: ${com.g_khater.g_stream.APIHolder.allProviders.size}")
        return com.g_khater.g_stream.APIHolder.allProviders.toTypedArray() //.filter { !it.usesWebView }
    }
    ...
    @Throws
    fun layoutTest() {
        ActivityScenario.launch(com.g_khater.g_stream.MainActivity::class.java).use { scenario ->
            scenario.onActivity { activity: com.g_khater.g_stream.MainActivity ->
               ...
               // testAllLayouts<ActivityMainBinding>(activity,R.layout.activity_main, R.layout.activity_main_tv)
                ...
                testAllLayouts<FragmentPlayerBinding>(activity,
                    com.lagradost.cloudstream3.R.layout.fragment_player,
                    com.lagradost.cloudstream3.R.layout.fragment_player_tv
                )
                testAllLayouts<FragmentPlayerTvBinding>(activity,
                    com.lagradost.cloudstream3.R.layout.fragment_player,
                    com.lagradost.cloudstream3.R.layout.fragment_player_tv
                )
               ...
               // testAllLayouts<FragmentResultTvBinding>(activity, R.layout.fragment_result,R.layout.fragment_result_tv)
                ...
                testAllLayouts<PlayerCustomLayoutBinding>(activity,
                    com.lagradost.cloudstream3.R.layout.player_custom_layout,
                    com.lagradost.cloudstream3.R.layout.player_custom_layout_tv,
                    com.lagradost.cloudstream3.R.layout.trailer_custom_layout
                )
                testAllLayouts<PlayerCustomLayoutTvBinding>(activity,
                    com.lagradost.cloudstream3.R.layout.player_custom_layout,
                    com.lagradost.cloudstream3.R.layout.player_custom_layout_tv,
                    com.lagradost.cloudstream3.R.layout.trailer_custom_layout
                )
                testAllLayouts<TrailerCustomLayoutBinding>(activity,
                    com.lagradost.cloudstream3.R.layout.player_custom_layout,
                    com.lagradost.cloudstream3.R.layout.player_custom_layout_tv,
                    com.lagradost.cloudstream3.R.layout.trailer_custom_layout
                )

                testAllLayouts<RepositoryItemBinding>(activity,
                    com.lagradost.cloudstream3.R.layout.repository_item_tv,
                    com.lagradost.cloudstream3.R.layout.repository_item
                )
                testAllLayouts<RepositoryItemTvBinding>(activity,
                    com.lagradost.cloudstream3.R.layout.repository_item_tv,
                    com.lagradost.cloudstream3.R.layout.repository_item
                )
                ...
                testAllLayouts<FragmentHomeBinding>(activity,
                    com.lagradost.cloudstream3.R.layout.fragment_home_tv,
                    com.lagradost.cloudstream3.R.layout.fragment_home
                )
                testAllLayouts<FragmentHomeTvBinding>(activity,
                    com.lagradost.cloudstream3.R.layout.fragment_home_tv,
                    com.lagradost.cloudstream3.R.layout.fragment_home
                )

                testAllLayouts<FragmentSearchBinding>(activity,
                    com.lagradost.cloudstream3.R.layout.fragment_search_tv,
                    com.lagradost.cloudstream3.R.layout.fragment_search
                )
                testAllLayouts<FragmentSearchTvBinding>(activity,
                    com.lagradost.cloudstream3.R.layout.fragment_search_tv,
                    com.lagradost.cloudstream3.R.layout.fragment_search
                )

                testAllLayouts<HomeResultGridBinding>(activity,
                    com.lagradost.cloudstream3.R.layout.home_result_grid_expanded,
                    com.lagradost.cloudstream3.R.layout.home_result_grid
                )
                //testAllLayouts<HomeResultGridExpandedBinding>(activity, R.layout.home_result_grid_expanded, R.layout.home_result_grid) ??? fails ???

                testAllLayouts<SearchResultGridExpandedBinding>(activity,
                    com.lagradost.cloudstream3.R.layout.search_result_grid,
                    com.lagradost.cloudstream3.R.layout.search_result_grid_expanded
                )
                testAllLayouts<SearchResultGridBinding>(activity,
                    com.lagradost.cloudstream3.R.layout.search_result_grid,
                    com.lagradost.cloudstream3.R.layout.search_result_grid_expanded
                )
               ...
               // testAllLayouts<HomeScrollViewTvBinding>(activity, R.layout.home_scroll_view, R.layout.home_scroll_view_tv)
                ...
                testAllLayouts<HomepageParentTvBinding>(activity,
                    com.lagradost.cloudstream3.R.layout.homepage_parent_tv,
                    com.lagradost.cloudstream3.R.layout.homepage_parent
                )
                testAllLayouts<HomepageParentBinding>(activity,
                    com.lagradost.cloudstream3.R.layout.homepage_parent_tv,
                    com.lagradost.cloudstream3.R.layout.homepage_parent
                )
